    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col px-4 md:px-20 absolute inset-0 overflow-y-auto">
          <div className="flex py-8 md:px-14 px-10 text-sm md:text-xl justify-between ml-1"></div>
          <div className="text-center">
            <div className="text-center w-full">
              <div className="flex flex-wrap justify-center items-center m-5 gap-x-10">
                ...
                {loadingSkeleton
                  ? Array.from({
                      length: works.filter((work) => work.isFavorite).length,
                    }).map((_, index) => (
                      <SkeletonTheme
